...
axios.get('https://jul1u5.herokuapp.com/notes').then(function (response) {
  var array = response.data;
  getData(array); // for (let i = 0; i < array.length; i++) {
...
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/axios */ "./JS/axios.js");
